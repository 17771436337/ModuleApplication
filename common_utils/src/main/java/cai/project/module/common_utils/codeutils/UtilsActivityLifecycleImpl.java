...
final class UtilsActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
    ...
    private final List<cai.project.module.common_utils.codeutils.Utils.OnAppStatusChangedListener>                mStatusListeners               = new ArrayList<>();
    private final Map<Activity, List<cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks>> mActivityLifecycleCallbacksMap = new ConcurrentHashMap<>();
    ...
    void addOnAppStatusChangedListener(final cai.project.module.common_utils.codeutils.Utils.OnAppStatusChangedListener listener) {
        mStatusListeners.add(listener);
    }

    void removeOnAppStatusChangedListener(final cai.project.module.common_utils.codeutils.Utils.OnAppStatusChangedListener listener) {
        mStatusListeners.remove(listener);
    }

    void addActivityLifecycleCallbacks(final Activity activity,
                                       final cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks listener) {
    ...
    private void addActivityLifecycleCallbacksInner(final Activity activity,
                                                    final cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks lifecycleCallbacks) {
        List<cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks> callbacks = mActivityLifecycleCallbacksMap.get(activity);
        if (callbacks == null) {
    ...
    void removeActivityLifecycleCallbacks(final Activity activity,
                                          final cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks callbacks) {
    ...
    private void consumeActivityLifecycleCallbacks(Activity activity, Lifecycle.Event event) {
        List<cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks> listeners = mActivityLifecycleCallbacksMap.get(activity);
        if (listeners != null) {
            for (cai.project.module.common_utils.codeutils.Utils.ActivityLifecycleCallbacks listener : listeners) {
    ...
    private void postStatus(final Activity activity, final boolean isForeground) {
        ...
        for (cai.project.module.common_utils.codeutils.Utils.OnAppStatusChangedListener statusListener : mStatusListeners) {
            if (isForeground) {
