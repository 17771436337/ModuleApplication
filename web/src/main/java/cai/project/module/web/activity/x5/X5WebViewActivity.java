package cai.project.module.web.activity.x5;
...
import cai.project.module.web.client.X5WebChromeClient;
import cai.project.module.web.client.X5WebViewClient;
import cai.project.module.web.interfac.IWebViewActivity;
import cai.project.module.web.view.FullscreenHolder;
import cai.project.module.web.view.X5WebView;
...
public class X5WebViewActivity extends AppCompatActivity implements IWebViewActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_x5_web_activity);
...
//                                showPreviewPhoto(picUrl);
                                Toast.makeText(X5WebViewActivity.this,"开发中",Toast.LENGTH_SHORT).show();
                                break;
                            case 1:
                                Toast.makeText(X5WebViewActivity.this,"开发中",Toast.LENGTH_SHORT).show();
