...
import cai.project.module.web.interfac.RichJavascriptInterface;
import cai.project.module.web.view.RichWebView;
...
public class RichWebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.web_activity_rich_webview_x5);
        initView();
        initToolBar();
        initWebView();
        initData();
...
//            showPreviewPhoto(position);
            Toast.makeText(RichWebViewActivity.this,"开发中",Toast.LENGTH_SHORT).show();
        });
    ...
    private void initData() {
        webView.setShow(getHtmlData("love1.html"));
        //获取所有图片
