package cai.project.module.common_httplibrary.convert;
...
import cai.project.module.common_httplibrary.model.SimpleResponse;
        ...
        if (rawType != BaseResponse.class) {
            ...
            if (typeArgument == Void.class) {
                ...
                if (code == 0){
                    ...
                    throw new OkGoHttpException(code,baseResponse.getMsg());
                }
