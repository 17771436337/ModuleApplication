package cai.project.module.love.adapter;
...
import cai.project.module.common_view.animation.star_cloud.view.PlanetView;

public class PlanetsAdapter extends PlanetAdapter {
    @Override
    public int getCount() {
        return 39;
    }
    ...
    public View getView(Context context, int position, ViewGroup parent) {
        ...
        int starWidth = SizeUtils.dp2px( 50.0f);
        int starHeight = SizeUtils.dp2px( 85.0f);
        int starPaddingTop = SizeUtils.dp2px(20.0f);
