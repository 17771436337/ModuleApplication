package cai.project.module.mqtt.service;
...
import cai.project.module.mqtt.R;


public class MQTTClientService extends Service {

    public static final String TAG = MQTTClientService.class.getSimpleName();

    private static MqttAndroidClient client;
    private MqttConnectOptions conOpt;

    private String host = "tcp://192.168.124.11:61613";
    private String userName = "admin";
    private String passWord = "password";
    private static String myTopic = "ForTest";      //要订阅的主题
    private String clientId = UUID.randomUUID().toString();//客户端标识
    private IGetMessageCallBack IGetMessageCallBack;

    private boolean isConnection = false;//连接状态
    ...
    public  void toCreateNotification(String message){
        PendingIntent pendingIntent = PendingIntent.getActivity(this, 1, new Intent(this,MQTTClientService.class), PendingIntent.FLAG_UPDATE_CURRENT);
