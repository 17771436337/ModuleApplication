...
public class PlanetView extends View {
    ...
    private void init(Context context) {
        ...
        signTextSize = SizeUtils.sp2px(9.0f);
        ...
        otherPaint.setTextSize((float) SizeUtils.sp2px( 9.0f));
        matchPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        matchPaint.setColor(0xFFFFFFFF);
        matchTextSize = SizeUtils.sp2px( 6.0f);
        matchPaint.setTextSize((float) matchTextSize);
        setLayerType(LAYER_TYPE_SOFTWARE, null);
        int startX = SizeUtils.sp2px( 45.0f);
        starWidth = SizeUtils.sp2px(35.0f);
        starMarginTop = 0;
